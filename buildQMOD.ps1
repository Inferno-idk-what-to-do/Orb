...
$filelist = @($mod, "assets/orbofpondering.bundle", "assets/gayfrog.bundle")
...
$zip = $qmodName + ".zip"
$qmod = $qmodName + "_" + $modJson.version + ".qmod"
...
Move-Item -Path $qmod -Destination './successful builds' -Force